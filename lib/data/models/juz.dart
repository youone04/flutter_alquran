class Juz {
  ...
  Juz(
     ...
     static int? _parseJuzEndSurahNumber(dynamic value) {
    if (value is int) {
      return value;
  ...
  Juz.fromJson(Map<String, dynamic> json) {
    juz = json['juz'];
    juzStartSurahNumber = _parseJuzEndSurahNumber(json['juzStartSurahNumber']);
    juzEndSurahNumber = _parseJuzEndSurahNumber(json['juzEndSurahNumber']);
